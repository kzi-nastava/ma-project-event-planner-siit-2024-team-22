...
@Composable
fun EventListContent(events: List<EventListItem>, paddingValues: PaddingValues) {
    LazyColumn(
        ...
        items(events) { event ->
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Text("Date: ${event.eventDate.format(DateTimeFormatter.ofPattern("dd MMM yyyy"))}", style = MaterialTheme.typography.bodySmall)
